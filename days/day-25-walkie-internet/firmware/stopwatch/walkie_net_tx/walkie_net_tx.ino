// ESPtember Day 25 — Internet Walkie-Talkie, transmitter half (StopWatch)
// Day 24 with one organ transplanted: the transport. The mic, the PTT
...
//
// Wi-Fi credentials come from day 23's NVS namespace (`wifi SSID PASS`
...
void setup() {
  ...
  prefs.begin("day22", false); // deliberately day 23's namespace:
