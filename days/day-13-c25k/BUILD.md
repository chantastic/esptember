# Day 13: Couch to 5K on the M5Stack StopWatch
...
| Gesture | Meaning |
| --- | --- |
| Right / Blue click | Next page or segment |
| Left / Yellow click | Previous page; restart the current segment during a workout |
...
days/day-13-c25k/scripts/build.sh
arduino-cli board list
days/day-13-c25k/scripts/flash.sh /dev/cu.usbmodem1101
```
...
```sh
cd ~/Developer/esptember
python3 -m venv days/day-13-c25k/.build/venv
days/day-13-c25k/.build/venv/bin/pip install pyserial pillow
days/day-13-c25k/.build/venv/bin/python days/day-13-c25k/scripts/check-device.py /dev/cu.usbmodem1101
```
...
The published [day 13 guide](https://esptember.com/day/day-13-c25k/) and [build story](https://esptember.com/day/day-13-c25k/story/) introduce this firmware.
