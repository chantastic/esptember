...
The whole build is day 11's one rule — clocks are arithmetic — under a musical deadline.
...
The downbeat gets a higher pitch, a longer buzz, a harder vibration — day 10's three-axis feedback code applied to musical structure.
