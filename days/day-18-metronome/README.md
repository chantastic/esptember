...
firmware: /firmware/day-18-metronome.bin
...
Day 11 taught that clocks are arithmetic, not counters.
...
Download [day-18-metronome.bin](https://esptember.com/firmware/day-18-metronome.bin) and open a terminal in the download directory.
...
uvx esptool --chip esp32s3 --port PORT \
  write-flash 0x0 day-18-metronome.bin
```
...
Same principle as day 11's stopwatch, pointed at rhythm.
...
The click is layered for no-look use: downbeats are a higher tone and a harder, longer vibration than the other beats — day 10's pitch-duration-intensity code, applied to bars.
...
- Day 10's feedback mapping: pitch encodes identity, duration and intensity encode importance.
