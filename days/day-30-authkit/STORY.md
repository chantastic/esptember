...
The same citizenship lesson as day 22's ten-minute weather refresh, now with the server enforcing it.
...
Wi-Fi arrives through day 21's `portal.c`, unmodified.
The client id follows the secrets-live-in-NVS rule, entered over day 22's serial grammar.
The HTTPS-with-cert-bundle pattern came from day 24.
