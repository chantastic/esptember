...
firmware: /firmware/day-24-walkie-talkie.bin
...
Day 21 proved the transport with 24-byte pokes; today saturates it with 16,000 bytes a second of voice.
...
[day-24-walkie-talkie.bin](https://esptember.com/firmware/day-24-walkie-talkie.bin) (StopWatch TX) and
[day-24-walkie-talkie-waveshare.bin](https://esptember.com/firmware/day-24-walkie-talkie-waveshare.bin) (AMOLED 1.8 RX).

Flash each at `0x0`:

```sh
uvx esptool --chip esp32s3 --port STOPWATCH_PORT \
  write-flash 0x0 day-24-walkie-talkie.bin
uvx esptool --chip esp32s3 --port WAVESHARE_PORT \
  write-flash 0x0 day-24-walkie-talkie-waveshare.bin
```
...
- Day 21's transport lessons: packed structs, broadcast etiquette, callbacks on the Wi-Fi task.
...
cd esptember/days/day-24-walkie-talkie
```
