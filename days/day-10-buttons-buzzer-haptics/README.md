...
firmware: /firmware/day-10-buttons-buzzer-haptics.bin
...
Download [day-10-buttons-buzzer-haptics.bin](https://esptember.com/firmware/day-10-buttons-buzzer-haptics.bin) and open a terminal in the download directory.
...
uvx esptool --chip esp32s3 --port PORT \
  write-flash 0x0 day-10-buttons-buzzer-haptics.bin
```
...
The rule comes from day 12's button grammar — a gesture owns its buttons until both release:
...
```sh
cd days/day-10-buttons-buzzer-haptics
./scripts/build.sh
