// ESPtember Day 28 — Real-Time Captions
...
// (`key YOUR_DEEPGRAM_KEY`), Wi-Fi via day 22's portal, audio path from
// day 15, WebSocket discipline from day 25. Board bring-up carries over
// from day 01.
#include <stdio.h>
#include <string.h>
...
static void mic_task(void *arg)
{
    ...
    while (1) {
        // The mic paces the stream, as in day 24: 200 ms per read, sent
