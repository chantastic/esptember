...
firmware: /firmware/day-08-sound-effects.bin
...
Day 07 made the screen an interface.
...
Download [day-08-sound-effects.bin](https://esptember.com/firmware/day-08-sound-effects.bin) and open a terminal in the download directory.
...
uvx esptool --chip esp32s3 --port PORT \
  write-flash 0x0 day-08-sound-effects.bin
```
...
```sh
cd days/day-08-sound-effects/firmware
idf.py build
