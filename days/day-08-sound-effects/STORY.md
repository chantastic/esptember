...
Day 07's harness pattern carried over unchanged and drove the whole checkout: tap ids verified against the firmware's own play counter, page flips confirmed by captured screenshot.
