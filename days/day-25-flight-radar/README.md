...
firmware: /firmware/day-25-flight-radar.bin
...
Download [day-25-flight-radar.bin](https://esptember.com/firmware/day-25-flight-radar.bin) and flash it at `0x0`:
...
The same streaming discipline as day 22, upgraded for payloads that stop being polite.
