...
The absence of input *is* the input, which makes this the purest possible exercise of day 11's rule: timestamps, not counters, and never block the loop, because the loop is literally reading silence.
