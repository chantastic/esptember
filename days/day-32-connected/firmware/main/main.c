// ESPtember Day 32 — Connected
// Day 31 signed in and kept nothing; this day makes the identity
...
// Board bring-up from day 01, Wi-Fi from day 22's portal, the device
// grant from day 31. The sequel (day 33) makes this identity do work.
#include <stdio.h>
#include <string.h>
