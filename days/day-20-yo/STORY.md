...
Both consoles print the verdict per frame, because "sent" and "received" are different claims and day 12's verification culture applies to radios too.
...
Interrupt-context discipline is the same lesson on every RTOS — day 20's version just arrived by radio.
