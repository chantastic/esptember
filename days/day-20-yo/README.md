...
firmware: /firmware/day-20-yo.bin
...
[day-20-yo.bin](https://esptember.com/firmware/day-20-yo.bin) (StopWatch) and
[day-20-yo-waveshare.bin](https://esptember.com/firmware/day-20-yo-waveshare.bin) (AMOLED 1.8).
...
uvx esptool --chip esp32s3 --port STOPWATCH_PORT \
  write-flash 0x0 day-20-yo.bin
uvx esptool --chip esp32s3 --port WAVESHARE_PORT \
  write-flash 0x0 day-20-yo-waveshare.bin
```
...
Reception differs by hardware, which is the point: the StopWatch answers a poke with vibration and a tone (day 10's channel), the Waveshare floods its touchscreen orange.
