...
So day 27 stopped pretending and became the lesson it wanted to be all along: **your first keyed API**, handled the way every real integration handles it.
...
Day 22 established that secrets live in NVS and arrive through a provisioning channel; day 23 gave that channel a serial grammar.
...
- Provisioning patterns compound. The key reused day 22's rule and day 23's grammar; the feature cost was one NVS field.
