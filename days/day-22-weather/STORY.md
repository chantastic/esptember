...
No key, no account, no OAuth dance — the API-key lesson is day 26's job, and weather gets to be pure.
...
Day 21's captive portal assumed a touchscreen and a phone.
