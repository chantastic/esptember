...
firmware: /firmware/day-22-weather.bin
...
Download [day-22-weather.bin](https://esptember.com/firmware/day-22-weather.bin) and open a terminal in the download directory.
...
- Day 21's rule, adapted: secrets in NVS only — this board's portal is a serial line instead of a web form.
