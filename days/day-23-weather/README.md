...
summary: "Keyless weather data reduced to a round current-conditions and hourly-forecast view."
verification: "Prompt contract and reference frame verified; generated hardware candidate awaits hand review"
---

## The assignment

Fetch, parse, cache, and display useful weather while offline and failure states remain honest.

The durable source is this prompt, [SPEC.md](https://github.com/chantastic/esptember/blob/main/days/day-23-weather/SPEC.md), the machine-readable contract, and its layered acceptance criteria.
Generated firmware is a disposable candidate.

## Reference frame

![Round-screen acceptance reference for Weather Station](https://esptember.com/images/day-23-weather/reference.png)
...
```text
Build ESPtember Day 23: Weather Station for the M5Stack Stopwatch Dev Kit (C152).
...
- days/day-23-weather/SPEC.md
- days/day-23-weather/tests/contract.json
...
Run scripts/prompt-contract/validate_day.sh days/day-23-weather before compiling a device candidate.
...
- Use Open-Meteo over TLS with explicit latitude, longitude, timezone, units, and response limits.
- Show current temperature, condition, high/low, wind, age of data, and a 12-hour bezel forecast.
- Left and right move Current, Hourly, and Settings; Enter refreshes or edits; Back returns to Current.
- Cache the last valid response and mark it stale instead of blanking the screen on a failed refresh.
- Filter JSON fields, validate ranges and timestamps, and use named HTTP, parse, and clock errors.

Diagnostics and acceptance

- Prefix serial protocol lines with D23_ and implement status, reset, action, capture, and touchlog commands.
