...
The redesign happened the moment day 28 worked: if the device can hear, the keyboard is a skeuomorph.
...
Thirty seconds of 8 kHz mono is 480 KB — the PSRAM that day 10 spent on a bubble sprite holds half a minute of your voice without noticing.
...
The fix (queue clips in NVS, retry later) is designed but not built — day 13's rule about never promising rollback you don't have applies to promises about durability too.
...
Day 11's chord grammar, now doing infrastructure work.
