...
Day 18 built the clock that speaks.
Day 19 builds the ear that listens back — and the two verify each other, which is the real reason they shipped as a pair.
...
Confidence itself is the day's best interface idea, borrowed from day 14's honesty streak: the fraction of gaps agreeing with the median.
Music scores high.
...
The verification plan needs no reference gear: set day 18 clicking at 120 on one board, point day 19 at it from the other.
