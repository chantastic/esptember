...
firmware: /firmware/day-21-captive-portal.bin
...
Download [day-21-captive-portal.bin](https://esptember.com/firmware/day-21-captive-portal.bin) and open a terminal in the download directory.
...
uvx esptool --chip esp32s3 --port PORT \
  write-flash 0x0 day-21-captive-portal.bin
```
...
```sh
cd days/day-21-captive-portal/firmware
idf.py build
