...
Null pointer.
LVGL was allocating from its builtin 64 KB pool — one missing `CONFIG_LV_USE_CLIB_MALLOC` line, lost when this day's config was derived from day 09's by careless truncation — and a 151-row list drinks 64 KB before it's a third built.

Day 08 had already learned this exact setting for snapshots.
