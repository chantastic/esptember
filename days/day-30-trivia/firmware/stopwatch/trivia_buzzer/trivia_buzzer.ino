// ESPtember Day 30 — Trivia, buzzer half (StopWatch)
// The capstone composes the month: ESP-NOW packets (day 21), button
// grammar (day 11), tones and haptics (day 11), and the fairness rule
...
void loop() {
  ...
  if (verdictPending) { // feedback from loop context, day 21's rule
