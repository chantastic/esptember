...
Keep the four-pad view, but turn it into a trap-oriented, four-measure 4/4 looper with 16 quarter notes total and independent Kick, Snare, automatic Hi-Hat, and Triple Hi-Hat tracks.
The regular Hi-Hat is an ON/OFF eighth-note pulse, so the player does not need to tap every hat. Kick, Snare, and 3X Hi-Hat keep the automatic four-measure replacement gesture.
...
The [Trap Looper exercise](https://github.com/chantastic/esptember/tree/main/days/day-09-sound-effects/extensions/drum-looper) specifies its 64-step loop, ON/OFF eighth-note Hi-Hat, tempo-locked three-stroke burst, per-track replacement rule, tap tempo, play/pause and clear controls, musical clock, tests, and hand review.
