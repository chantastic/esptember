...
## Next exercise: Drum Looper

Keep the four-pad view, but turn it into a four-measure, 4/4 looper with 16 quarter notes total and independent Kick, Snare, Hi-Hat, and Crash tracks.
...
The [Drum Looper exercise](https://github.com/chantastic/esptember/tree/main/days/day-09-sound-effects/extensions/drum-looper) specifies its 64-step loop, per-track replacement rule, tap tempo, play/pause and clear controls, musical clock, tests, and hand review.
