...
firmware: /firmware/day-32-pipes.bin
...
Day 31's resident identity gets a job.
...
uvx esptool --chip esp32s3 --port PORT \
  write-flash 0x0 day-32-pipes.bin
```
...
Gateway: `days/day-32-pipes/gateway` (wrangler).
Firmware: `days/day-32-pipes/firmware` (`idf.py build`), `GATEWAY` constant at the top of `main.c`.
